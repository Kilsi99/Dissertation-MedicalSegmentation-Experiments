...
Original file is located at
    https://colab.research.google.com/drive/1jMKTi24ynJr7QiWg3DT2ju8Zjl1F5D45
"""
...
# U-Net Architecture starting at 32 channels
class Unet_2D(nn.Module):
    def __init__(self, channels_in, channels_out):
        super(Unet_2D, self).__init__()

        # Encoder
        self.Encoder_block1 = Encoder_block(channels_in, 32)
        ...
        # Decoder
        self.decoder_block4 = Decoder_block(512, 256, 256)
        self.decoder_block3 = Decoder_block(256, 128, 128)
        self.decoder_block2 = Decoder_block(128, 64, 64)
        self.decoder_block1 = Decoder_block(64, 32, 32)

        # Output layer
        self.output = nn.Conv2d(32, channels_out, kernel_size=1)
...
unet_model = Unet_2D(3,2) # Changed output channels from 32 to 2
...
save_model(unet_model, '/content/drive/MyDrive/Dissertation/polyp_datasets/models')

Unet_model = Unet_2D(3,2)
Unet_model.load_state_dict(torch.load('/content/drive/MyDrive/Dissertation/polyp_datasets/models/unet_model.pth', map_location= torch.device('cpu')))
...
test_model_hausdorff95(Unet_model, test_loader, device)
...
masks_imgs_list = [predict_and_visualize_mask(c, Unet_model, device, test_img_transform, img_dir, mask_dir) for c in case_list_num]
