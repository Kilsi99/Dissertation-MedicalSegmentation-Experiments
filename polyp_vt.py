...
Original file is located at
    https://colab.research.google.com/drive/1E8a5FMl7Txx6e4Gsgj1pw0BrJJsCUTVz
"""
...
def save_model(model, save_dir, filename="VT_model1.pth"):
...
VT_model.load_state_dict(torch.load('/content/drive/MyDrive/Dissertation/polyp_datasets/models/VT_model1.pth', map_location= torch.device('cpu')))
